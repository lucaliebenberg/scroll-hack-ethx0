...
export const env = createEnv({
  client: {
    ...
    NEXT_PUBLIC_SCROLL_SEPOLIA_ACCOUNT_ID: z.string().min(1),
    NEXT_PUBLIC_SCROLL_SEPOLIA_PRIVATE_KEY: z.string().min(1),
    NEXT_PUBLIC_GASLESS_SIGNER: z.string().min(1),
  },
  runtimeEnv: {
    NEXT_PUBLIC_BANDADA_SDK_API_KEY: process.env.NEXT_PUBLIC_BANDADA_SDK_API_KEY,
    NEXT_PUBLIC_SCROLL_SEPOLIA_ACCOUNT_ID: process.env.NEXT_PUBLIC_SCROLL_SEPOLIA_ACCOUNT_ID,
    NEXT_PUBLIC_SCROLL_SEPOLIA_PRIVATE_KEY: process.env.NEXT_PUBLIC_SCROLL_SEPOLIA_PRIVATE_KEY,
